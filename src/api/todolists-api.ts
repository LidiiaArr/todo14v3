...
export const todolistsAPI = {
    ...
    createTodolist(title: string) {
        ...
        // ResponseType<{ item: TodolistType } то что мы получаем со стороны бекенда
        //AxiosResponse<ResponseType<{ item: TodolistType }>> то что возвращает бекенд
        //дублирование нужно из-того что нужно указать тип третьего параметра
        //третий параметр то что мы передаем на бекенд
        //важно указать два первых праметра чтобы дойти до третьего
        //ResponseType<{ item: TodolistType }> первый дженерик игнорируется когда указывается второй
        //AxiosResponse главный параметр его нужно явно указывать
    },
...
export type ResponseType<D = {}> = { //дженерик чтобы не дублировать код
    resultCode: number
