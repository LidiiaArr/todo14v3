...
function App() {
    ...
    useEffect(()=> {
        dispatch(getTodoListsTC() )//диспатчит санкКриэйтор которая создает thunk
        //thunk вызовет middleware
    },[])
    ...
    //     //     })
    // }, []) //получаем тудулисты один раз поэтому массив зависимостей пустой
        ...
        <div className="App">
            ...
            <Container fixed>
                ...
                <Grid container spacing={3}>
                    {
                        todolists.map(tl => {
                            let allTodolistTasks = tasks[tl.id]; //подставляем тудулист id к ассоциатиному массиву
